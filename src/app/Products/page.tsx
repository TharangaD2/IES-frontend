...
const products: Product[] = [
    ...
    },
    {
        ...
        category: 'mechanical',
        description: 'High-quality industrial valves for reliable fluid control',
        features: ['Durable construction', 'Precise control', 'Industrial grade'],
        image: 'https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=600&q=80',
    },
    {
        id: 14,
        name: 'Piping Systems',
        category: 'plumbing',
        description: 'Comprehensive piping solutions for commercial and industrial use',
        features: ['Leak-proof', 'Various materials', 'Easy installation'],
        image: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=600&q=80',
    },
    {
        id: 15,
        name: 'Traps',
        category: 'plumbing',
        description: 'Efficient traps for steam and plumbing systems',
        features: ['High performance', 'Minimal maintenance', 'Robust design'],
        image: 'https://images.unsplash.com/photo-1585704032915-c3400ca199e7?w=600&q=80',
    },
    {
        id: 16,
        name: 'Pipe Hangers and Conduit Clamps',
        category: 'mechanical',
        description: 'Secure mounting solutions for pipes and conduits',
        features: ['Heavy-duty', 'Adjustable', 'Corrosion resistant'],
        image: 'https://images.unsplash.com/photo-1621905252507-b35492cc74b4?w=600&q=80',
    },
    {
        id: 17,
        name: 'Metal Cable Management Systems',
        category: 'electrical',
        description: 'Unperforated and perforated cable trays, ladders, wire mesh, and underfloor systems',
        features: ['Pre-Galvanized', 'Hot Dipped Galvanized', 'Zinc Aluminum (ZAM)', 'Powder Coated'],
        image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80',
    },
    {
        id: 18,
        ...
        category: 'electrical',
        description: 'Reliable low voltage systems for power distribution and control',
        features: ['High reliability', 'Efficient distribution', 'Industrial grade'],
        image: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=600&q=80',
    },
    {
        id: 19,
        name: 'GRP & FRP Cable Management',
        category: 'electrical',
        description: 'Glass Reinforced Plastic and Fiber Reinforced Plastic cable management systems',
        features: ['Corrosion resistant', 'High strength', 'Lightweight'],
        image: 'https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=600&q=80',
    },
    {
        id: 20,
        name: 'Solar Panel Mounting Systems',
        category: 'electrical',
        description: 'Ground-mounted and roof-mounted structural supports for solar panels',
        features: ['Ground-mounted', 'Roof-mounted', 'Durable design'],
        image: 'https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?w=600&q=80',
    },
    {
        id: 21,
        ...
        category: 'electrical',
        description: 'Faraday Cage and ESE Systems for robust lightning protection',
        features: ['Copper & GI options', 'Aluminum options', 'Stainless-Steel options'],
        image: 'https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=600&q=80',
    },
    {
        id: 22,
        ...
        category: 'electrical',
        description: 'Advanced devices to protect electrical systems from voltage spikes',
        features: ['Fast response', 'High capacity', 'Din-rail mountable'],
        image: 'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=600&q=80',
    },
    {
        id: 23,
        name: 'GI Conduits',
        category: 'electrical',
        description: 'Hot Dipped Galvanized rigid conduits for electrical wiring',
        features: ['Class 3 options', 'Class 4 options', 'Heavy duty'],
        image: 'https://images.unsplash.com/photo-1585704032915-c3400ca199e7?w=600&q=80',
    },
    {
        id: 24,
        name: 'Low Voltage Distribution Boards',
        category: 'electrical',
        description: 'Main and sub-distribution boards for low voltage networks',
        features: ['Custom configurations', 'High safety standards', 'Easy access'],
        image: 'https://images.unsplash.com/photo-1621905252507-b35492cc74b4?w=600&q=80',
    },
    {
        id: 25,
        name: 'Weather Proof Enclosures',
        category: 'electrical',
        description: 'Durable enclosures and junction boxes for harsh environments',
        features: ['High IP rating', 'Weather resistant', 'Secure sealing'],
        image: 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=600&q=80',
    },
    {
        id: 26,
        name: 'Electrical Water Leak Detection',
        category: 'electrical',
        description: 'Advanced water leak detection and alarm systems',
        features: ['Instant alerts', 'High sensitivity', 'Integrated alarms'],
        image: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=600&q=80',
    },
    {
        id: 27,
        name: 'Fire Sealant & Protection',
        category: 'mechanical',
        description: 'Advanced fire sealant and fire protection systems for structural safety',
        features: ['Intumescent sealing', 'High temperature resistance', 'Easy application'],
        image: 'https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=600&q=80',
    },
    {
        id: 28,
        ...
        category: 'mechanical',
        description: 'Comprehensive thermal management for industrial applications',
        features: ['Energy efficient', 'Custom design', 'High reliability'],
        image: 'https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?w=600&q=80',
    },
    {
        id: 29,
        ...
        category: 'mechanical',
        description: 'Industrial and domestic gas detection systems for safety monitoring',
        features: ['High sensitivity', 'Audible alarms', 'Multi-gas detection'],
        image: 'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=600&q=80',
    },
    {
        id: 30,
        name: 'Door Seals & Finger Protection',
        category: 'mechanical',
        description: 'Safety door seals and finger protection systems for commercial doors',
        features: ['Durable material', 'Easy installation', 'Maximum safety'],
        image: 'https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=600&q=80',
    },
    {
        id: 31,
        ...
        category: 'mechanical',
        description: 'Heavy-duty industrial exhaust fans for efficient ventilation',
        features: ['High airflow', 'Low noise', 'Energy efficient'],
        image: 'https://images.unsplash.com/photo-1621905252507-b35492cc74b4?w=600&q=80',
    },
    {
        id: 32,
        name: 'Thermostats',
        category: 'mechanical',
        description: 'Precision thermostats for accurate temperature control',
        features: ['Digital display', 'Programmable', 'Accurate sensing'],
        image: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=600&q=80',
    },
    {
        id: 33,
        name: 'Heaters',
        category: 'mechanical',
        description: 'Industrial and commercial heating solutions',
        features: ['Fast heating', 'Thermostatic control', 'Safe operation'],
        image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80',
    },
    {
        id: 34,
        name: 'Water Meters',
        category: 'mechanical',
        description: 'Accurate water measurement and metering systems',
        features: ['High precision', 'Durable casing', 'Clear display'],
        image: 'https://images.unsplash.com/photo-1585704032915-c3400ca199e7?w=600&q=80',
    },
    {
        id: 35,
        ...
        category: 'mechanical',
        description: 'ERW and seamless options for galvanized and steel pipes and fittings',
        features: ['Seamless options', 'ERW options', 'Corrosion resistant'],
        image: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=600&q=80',
    },
    {
        id: 36,
        name: 'Gate and Control Valves',
        category: 'mechanical',
        description: 'Reliable gate valves and control valves for fluid management',
        features: ['Precise control', 'High pressure rated', 'Industrial grade'],
        image: 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=600&q=80',
    },
    {
        id: 37,
        name: 'Fire & Smoke Curtains',
        category: 'mechanical',
        description: 'Automatic deployable fire curtains and smoke curtains',
        features: ['Fire rated', 'Auto deployment', 'Custom sizes'],
        image: 'https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=600&q=80',
    }
];
                ...
                <div className="container mx-auto px-6 lg:px-12 relative">
                    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl">
                        ...
                        <p className="text-xl text-gray-300">
                            Infinity Engineering Solutions offers a broad portfolio of engineering products, services, and system solutions. supporting  mechanical, electrical,  and plumbing projects.
                        </p>
                    </motion.div>
                </div>
            </section>
